...
%                   old-style and parallel mesh files, with linear (4-node tet or
%                   8-node hex) or quadratic (10-node tet or 20-node hex) elements.
%
% Usage:
...
%   Elem  - [Ne x k] element connectivity (k = 4 or 8 linear, 10 or 20 quadratic).
