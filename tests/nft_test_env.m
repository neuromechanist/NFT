...
%   absent, e.g. on a bare CI checkout without a sibling NFT_test/EEGLAB.
  ...
  hasDsl = ~isempty(dslDir) ...
      && exist(fullfile(dslDir, 's1_LFM.mat'),   'file') == 2 ...
      && exist(fullfile(dslDir, 'ss_g10.mat'),   'file') == 2 ...
      && exist(fullfile(dslDir, 'FSss_cor.mat'), 'file') == 2 ...
      && exist(fullfile(dslDir, 'Node_area.mat'),'file') == 2 ...
      && exist(fullfile(dslDir, 'jc_s1.sensors'),'file') == 2 ...
      && exist(fullfile(dslDir, 'Amica_comps_nft_sh.set'), 'file') == 2;
